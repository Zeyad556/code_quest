                    ...
                    child: RadioListTile<String>(
                      ...
                      title: Text(
                        ...
                        style: TextStyle(
                          fontSize: 25.sp,
                          fontWeight: FontWeight.bold,
                          color: selectedAnswer == answers[index] ? Colors.black : Colors.white,
                        ),
                      ),
                      ...
                      tileColor: selectedAnswer == answers[index] ?Color.fromARGB(200, 65, 8, 70) : Colors.deepPurple, //9C27B0FF
